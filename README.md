...
Insert paired tracks of corpus in the folder as `./00_corpus/<corpus-name>/<track-name>/source.wav` and `./00_corpus/<corpus-name>/<track-name>/target.wav`. Arguments for each of these python scripts have to be insterted in the scripts, in the dictionary at the beginning of the main method (I will update it soon as script arguments).
